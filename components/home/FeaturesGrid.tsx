      ...
      <div className="border-b border-gray-400 pb-12 sm:pb-16 md:pb-20">
        <div className="flex flex-col justify-between gap-6 md:flex-row">
          <h2 className="text-goldClr font-kalnia text-3xl font-medium md:w-1/2">
            What makes shopping sarees with us special?
          </h2>
          <p className="text-white md:w-1/2">
            From handpicked fabrics to doorstep delivery, we take care of everything so you can simply enjoy the experience of finding your perfect saree.
          </p>
        </div>
